...
public class HeapTree {
    ...
    /* heap.Heap size is number of nodes in the tree */
   ...
   public void print(Node node) {
    ...
    public static void main(String[] args) {
        System.out.println("********* heap.Heap Tree Implementation **********");
